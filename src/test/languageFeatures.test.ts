...
suite('Language Features Test Suite', () => {
  ...
  test('MDP file should have correct language ID', async () => {
    // 使用项目根目录的 test-fixtures 测试文件
    const mdpFile = path.join(__dirname, '..', '..', '..', 'test-fixtures', 'test.mdp');
  ...
  test('GRO file should have correct language ID', async () => {
    const groFile = path.join(__dirname, '..', '..', '..', 'test-fixtures', 'test.gro');
  ...
  test('NDX file should have correct language ID', async () => {
    const ndxFile = path.join(__dirname, '..', '..', '..', 'test-fixtures', 'test.ndx');
