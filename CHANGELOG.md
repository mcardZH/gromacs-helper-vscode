...
- **修复依赖安全漏洞 (CVE-2026-29063)**:
  - 升级 `immutable` 依赖至安全版本 `5.1.9`（>= 5.1.5），彻底修复原型污染（Prototype Pollution）安全漏洞

### 文档与资源

- **完善 README 与演示资源**:
  - 全面更新中英文 README 文档，增加力场文件支持、二进制文件预览、Mol* 3D 轨迹播放器等新特性的详细图文说明
  - 补充集成了 22 项核心功能的完整演示截图与动画（涵盖 MDP、TOP/ITP、GRO、PDB、NDX、XVG、Packmol、进程监控与轨迹播放）
